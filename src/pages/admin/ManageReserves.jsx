...
import { API_GET_RESERVATIONS_BY_USER, API_DELETE_RESERVATION } from "../../config/apiEndpoints"
   ...
   const headers = {
    ...
    const handleFindResults = useCallback(async () => {
      try {
        ...
        const formattedPastReservations = pastReservations.map(reservation => ({
            ...reservation,
            startTime: formatTime(reservation.startTime),
            endTime: formatTime(reservation.endTime),
        }));
        ...
        setFutureReservations(formattedFutureReservations);
        setPastReservations(formattedPastReservations);
      ...
      <div>
         ...
         <TableSection>
          ...
          <Paragraph text="No hi ha reserves fetes." />
              ...
              <>
              <Table columns={columnsReserves} data={futureReservations} columnMapping={columnMappingReserves} actions={['delete']} onDelete={handleDeleteClick} />
              <TableMobile data={futureReservations} type='reserveUser' actions={['delete']} onDelete={handleDeleteClick} />
            </>
            )}
