...
const config = {
  ...
  style: {
    seat: {
      hover: 'var(--white)', // Color al pasar el ratón por encima
      color: "var(--white)", // Color del asiento
      selected: 'var(--lightviolet)', // Color del asiento seleccionado
      check_icon_color: '#fffff', // Color del icono de verificación
      not_salable: "var(--grey)", // Color del asiento no disponible para la venta
      focus: 'var(--white)', // Color del asiento enfocado
    },
    legend: {
      font_color: 'var(--blue)', // Color de la fuente de la leyenda
