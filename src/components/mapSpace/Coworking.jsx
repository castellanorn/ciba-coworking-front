...
const initialBlocks = [
  { id: 1, title: "T1", available: "not_salable", seats: [
  ...
  { id: 2, title: "T2", available: "not_salable", seats: [  
  ...
  { id: 3, title: "T3", available: "color", seats: [
  ...
  { id: 4, title: "T4", available: "not_salable", seats: [
  ...
  { id: 5, title: "T5", available: "color", seats: [
  ...
  { id: 6, title: "T6", available:"color", seats: [
    ...
    { id: 7, title: "T7", available:"color", seats: [
    ...
    { id: 8, title: "T8", available: "not_salable", seats: [  
    ...
    { id: 9, title: "T9", available:"not_salable", seats: [
    ...
    { id: 10, title: "T10", available: "color", seats: [
    ...
    { id: 11, title: "T11", available: "not_salable", seats: [
    ...
    { id: 12, title: "T12", available: "not_salable", seats: [
    ...
    { id: 13, title: "T13", available: "not_salable", seats: [
    ...
    { id: 14, title: "T14", available: true, seats: [
    ...
    { id: 15, title: "T15", available: true, seats: [  
    ...
    { id: 16, title: "T16", available: true, seats: [
    ...
    { id: 17, title: "T17", available: false, seats: [
    ...
    { id: 18, title: "T18", available: true, seats: [
    ...
    { id: 19, title: "T19", available: true, seats: [
    ...
    { id: 20, title: "T20", available: true, seats: [
    ...
    { id: 21, title: "T21", available: true, seats: [
    ...
    { id: 22, title: "T22", available: true, seats: [
    ...
    { id: 23, title: "T23", available: true, seats: [
    ...
    { id: 24, title: "T24", available: true, seats: [
    ...
    { id: 25, title: "T25", available: true, seats: [
    ...
    { id: 26, title: "T26", available: true, seats: [
    ...
    { id: 27, title: "T27", available: true, seats: [
    ...
    { id: 28, title: "T28", available: false, seats: [
    ...
    { id: 29, title: "T29", available: true, seats: [
    ...
    { id: 30, title: "T30", available: true, seats: [
    ...
    { id: 31, title: "T31", available: true, seats: [
    ...
    { id: 32, title: "T32", available: true, seats: [
    ...
    { id: 33, title: "T33", available: true, seats: [
    ...
    { id: 34, title: "T34", available: true, seats: [
    ...
    { id: 35, title: "T35", available: true, seats: [
    ...
    { id: 36, title: "T36", available: true, seats: [
    ...
    { id: 37, title: "T37", available: true, seats: [
    ...
    { id: 38, title: "T38", available: true, seats: [
    ...
    { id: 39, title: "T39", available: false, seats: [
    ...
    { id: 40, title: "T40", available: true, seats: [
    ...
    { id: 41, title: "T41", available: true, seats: [
    ...
    { id: 43, title: "T43", available: true, seats: [
    ...
    { id: 44, title: "T44", available: true, seats: [
    ...
    { id: 45, title: "T45", available: true, seats: [
    ...
    { id: 46, title: "T46", available: true, seats: [
    ...
    { id: 47, title: "T47", available: false, seats: [
    ...
    { id: 48, title: "T48", available: true, seats: [
    ...
    { id: 49, title: "T49", available: true, seats: [
    ...
    { id: 50, title: "T50", available: true, seats: [
...
const Coworking = () => {
  ...
  return (
    <Container>
      <Plano blocks={blocks} onSeatClick={handleSeatClick} config={config} /> {/* Renderiza el SVG con los bloques */}
      <Seatmap
        ref={seatmapRef}
